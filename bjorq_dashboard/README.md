...
1. Go to **Inställningar → Home Assistant** and enter your HA URL + access token
2. Switch to **Build Mode** to import a 3D model or draw your layout
3. Place devices and link them to HA entities
4. Switch back to **Home View** to control your smart home

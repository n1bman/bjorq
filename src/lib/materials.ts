...
const rawPresetMaterials: Material[] = [
  ...
  // ─── Wood (B5: realWorldSize — square to match 1:1 texture sources) ───
  { id: 'mat-oak', name: 'Ek', type: 'wood', color: '#c8a568', roughness: 0.68, surfaceCategory: 'wood',
    hasTexture: true, repeat: [1, 2], source: 'Poly Haven', realWorldSize: [1.0, 1.0],
  ...
  { id: 'mat-pine', name: 'Furu', type: 'wood', color: '#d8bc7e', roughness: 0.73, surfaceCategory: 'wood',
    hasTexture: true, repeat: [1, 2], source: 'ambientCG', realWorldSize: [1.0, 1.0],

...
export const openingPresets: OpeningPreset[] = [
  ...
  { id: 'win-6pane-frost-mid', label: '6-rutors frostat mitt', type: 'window', width: 1.0, height: 1.4, sillHeight: 0.9, style: '6pane-frost-mid', description: '100×140 cm, 6 rutor, frostat mittrad' },

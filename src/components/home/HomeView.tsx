...
import { Eye, EyeOff, Lightbulb, Thermometer, Wind, Camera, Power, Tv, Fan, Shield, Droplets, X, Wifi, Settings2, Play, Pause, Home as HomeIcon, Square, Plus, Minus } from 'lucide-react';
